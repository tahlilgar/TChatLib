...
public class ChatAppMsgViewHolder extends RecyclerView.ViewHolder {
    ...
    public TextView leftMsgTextView, rightMsgTextView, Operator_name, Timesend, TimeResive, TimeImgsend, TimeImgResive, TimeVideosend, TimeVideoResive, TimeVoicesend, TimeVoiceResive, VoiceReciveName, VoiceSendName, txtDate;

    public ImageView imageSend, imageResive, msg_send_seen,
            img_send_seen, video_send_seen, voice_send_seen, Msg_Send_Edit, msg_receive_edit;
